...
impl NetworkProcessor {
    ...
    /// If you want to run the thread again, call [`NetworkProcessor::wait()`]
    /// to ensure the thread is totally finished before run it again.
...
mod tests {
    ...
    fn processor_thread() {
        ...
        assert!(processor.is_running());
        processor.stop();
        assert!(processor.is_running()); // The stop only notifies, it continues running.
